...
const SALES_TRIGGERS: ActionTrigger[] = [
  ...
  },
  {
    ...
    promptInstruction:
      "You are in Sales mode. The prospect mentioned a competitor. Position momor's advantages confidently without disparaging the competitor.",
...
const TEAM_TRIGGERS: ActionTrigger[] = [
  ...
  },
  {
    ...
    promptInstruction:
      "You are in Team Meeting mode. Summarize the decision that was made.",
