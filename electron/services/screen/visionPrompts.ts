...
export const DIRECT_VISION_SYSTEM_PROMPT = `You are momor's screen understanding and live assistance engine.
...
export const TECHNICAL_INTERVIEW_SYSTEM_PROMPT = `You are momor's technical interview copilot.
...
export const CODE_DEBUG_SYSTEM_PROMPT = `You are momor's code analysis assistant.
...
export const STRUCTURED_EXTRACTION_SYSTEM_PROMPT = `You are momor's screen understanding engine. Extract structured information from the attached screenshot.
...
export const GENERAL_VISION_SYSTEM_PROMPT = `You are momor's screen understanding assistant.
