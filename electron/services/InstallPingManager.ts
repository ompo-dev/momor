 ...
 * - "app": "momor" (hardcoded app identifier)
...
/**
 * Anonymous install ping endpoint — disabled in open-source build.
 */
const INSTALL_PING_URL = "";
...
export async function sendAnonymousInstallPing(): Promise<void> {
  console.log(
    "[InstallPingManager] Install ping disabled (open-source build).",
  );
}
