...
export interface NativeModule {
  ...
  // window so clicks/keystrokes don't activate momor (foreground app
 ...
 *
 * We bypass `require('momor-audio')` intentionally. That approach relied on
 * npm creating a symlink from node_modules/momor-audio -> native-module/,
