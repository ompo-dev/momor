...
export class SettingsWindowHelper {
  ...
  public showWindow(
    ...
    if (process.platform === "win32" && this.contentProtection) {
      ...
      else this.settingsWindow.showInactive();
  ...
  private createWindow(
    ...
    this.settingsWindow.once("ready-to-show", () => {
      ...
      // momor overlay doesn't activate the momor app and dim
      ...
      if (
        ...
        try {
          ...
          console.error(
            "[SettingsWindowHelper] applyStealthToWindow failed:",
            e,
          );
        }
      }
    ...
    // OS level and routes them into momor's chat input — the user
