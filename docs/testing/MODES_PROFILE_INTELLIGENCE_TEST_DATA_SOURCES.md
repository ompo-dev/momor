...
| `general_metrics_sheet.csv`        | csv          | synthetic_fallback | "Q1 ARR run-rate $480k for momor pilot"               | "what is the Q1 ARR"           | $480k figure             | invented MRR numbers           |
...
| File                           | Type        | Source             | Sentinel facts                                                        | Retrieval queries                            | Answer must include               | Answer must NOT include |
| ------------------------------ | ----------- | ------------------ | --------------------------------------------------------------------- | -------------------------------------------- | --------------------------------- | ----------------------- |
| `lfw_resume.txt`               | txt         | synthetic_fallback | "Built PriceX, a price-comparison website; scaled momor to 10k users" | "tell me about a project you scaled"         | PriceX or momor scale             | invented FAANG roles    |
