...
Version: 1.0  
Owner: momor QA automation  
Last updated: 2026-05-15

## 1. Mission

momor's reported-bug fix cycle does not verify whether each mode behaves like a real product. This plan establishes a deep, **realistic, end-to-end** test system for:
...
9. momor API integration (when configured)
...
1. Behavioral interview — resume includes PriceX & momor (sentinel: "candidate built PriceX, a price-comparison website, and scaled momor to 10k users").
...
| 9     | Real momor API integration (env-gated)                | Skipped unless env set |
