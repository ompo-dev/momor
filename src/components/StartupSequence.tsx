...
import MomorInterfaceCard from "./MomorInterfaceCard";
...
const FONTS = {
  ...
  celebMedium:
    "'Celeb MF Medium', 'Geist', ui-sans-serif, system-ui, sans-serif",
  ...
  <div className="flex items-center justify-center gap-5 text-[#9ea3ab] opacity-90 select-none mb-10 translate-y-2">
    ...
    <div className="flex items-center gap-1.5 transition-opacity hover:opacity-100">
      <div className="w-[18px] h-[18px] bg-current flex items-center justify-center rounded-[1.5px] transform -translate-y-[1px]">
        <span
          className="text-[13px] font-bold text-[#f3f3f4] leading-none pb-[1px]"
      ...
      <span
        className="text-[14px] font-bold tracking-tight text-current"
        style={{ fontFamily: "Verdana, sans-serif" }}
      >
        Hacker News
      </span>
    ...
    <div className="flex items-center gap-1.5 transition-opacity hover:opacity-100">
      <svg
        className="w-[20px] h-[20px] fill-current transform -translate-y-[1px]"
        viewBox="0 0 24 24"
      >
      ...
      <span
        className="text-[14.5px] font-black tracking-tight text-current"
        style={{ fontFamily: FONTS.interMedium, fontWeight: 900 }}
      >
        Product Hunt
      </span>
    </div>
    ...
    <div className="flex items-center gap-1.5 transition-opacity hover:opacity-100">
      <svg
        className="w-[22px] h-[22px] fill-current transform -translate-y-[1px]"
        viewBox="0 0 24 24"
      >
      ...
      <span
        className="text-[16px] font-semibold tracking-tighter text-current"
...
const StartupSequence: React.FC<StartupSequenceProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex flex-col items-center w-full mt-auto wrap"
        ...
        >
          ...
          >
            <motion.button
              ...
              style={{
                background:
                  "linear-gradient(100deg, #5f7ee8 0%, #6f97ee 50%, #88b6f7 100%)",
            ...
            >
              ...
              <span
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, rgba(255,255,255,0.22), rgba(255,255,255,0.06) 35%, transparent 60%)",
                }}
              />
        ...
        >
          <p
            className="text-[12px] opacity-60 mb-6 text-center"
            style={{ color: "#a7a7ad" }}
          >
            {t('startup.agreement')}{" "}
            <span
      ...
      >
        ...
        >
          {/* A. momorInterfaceCard — slightly wider, on top */}
          <motion.div
