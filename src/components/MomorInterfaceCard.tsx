...
import momorLogo from "../assets/logo.webp";

const DARK_GLASS = {
  background:
    "linear-gradient(160deg, rgba(90,90,108,0.88) 0%, rgba(55,55,70,0.93) 50%, rgba(36,36,50,0.97) 100%)",
  boxShadow:
...
const hotkeys = [
  {
    label: "What should I answer?",
    icon: (
      <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
        <path
          d="M2 6h8M2 3.5h5M2 8.5h6"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
        <path
          d="M10 6A4 4 0 112 6M10 6l-1.5-1.5M10 6l1.5-1.5"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const MomorInterfaceCard = ({
  ...
  return (
    <div
      className={className}
      style={{
        transform: isStatic ? undefined : isMobile ? "scale(1)" : "scale(0.85)",
      ...
      >
        ...
        {!hidePill && (
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(90,90,108,0.68) 0%, rgba(55,55,70,0.72) 50%, rgba(36,36,50,0.76) 100%)",
              backdropFilter: "blur(3px)",
              padding: "4px",
              boxShadow:
                "0 4px 20px rgba(0,0,0,0.30), inset 0 1px 0 rgba(255,255,255,0.11)",
            }}
          >
            <div className="absolute inset-x-1 top-0.5 h-[45%] rounded-full bg-gradient-to-b from-white/20 to-white/0 blur-[0.5px] pointer-events-none" />
            ...
            {/* Hide */}
            <div
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-white/75 text-[12px] font-medium tracking-[0.02em] relative overflow-hidden"
              style={DARK_GLASS}
            >
              {GLOSS}
              <svg
            ...
            {/* Stop */}
            <div
              className="w-8 h-8 rounded-full flex items-center justify-center border border-white/15 text-white/50 relative overflow-hidden"
              style={{
                background:
                  "linear-gradient(170deg, rgba(60,60,72,0.9) 0%, rgba(25,25,30,0.95) 100%)",
              }}
            >
          ...
          style={
            dreamyVariant
              ? {
                  ...
                  borderRadius: "20px",
                  boxShadow:
                    "inset 0 1px 1px rgba(255,255,255,0.2), 0 20px 40px rgba(0,0,0,0.15)",
                }
              : {
                  ...DARK_GLASS,
                  borderRadius: "24px",
                  ...
                  boxShadow:
                    "0 12px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.12), 0 0 0 0.5px rgba(255,255,255,0.08)",
                }
          }
        >
          {/* Jelly gloss */}
          <div
            ...
            style={{
              borderRadius: dreamyVariant ? "20px 20px 0 0" : "24px 24px 0 0",
              background: dreamyVariant
                ? "linear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0) 100%)"
                : "linear-gradient(to bottom, rgba(255,255,255,0.20) 0%, rgba(255,255,255,0.01) 100%)",
            }}
          />
          ...
          {!hideMessages && (
            <div className="px-4 pt-4 pb-2 flex justify-end">
              <div
                className="relative px-4 py-2 rounded-full text-white text-[13px] font-semibold shadow-[0_8px_20px_rgba(37,99,235,0.35)] border border-white/20"
                style={{
                  background:
          ...
          {!hideMessages && (
            <div className="px-4 pb-2">
              <p className="text-white/90 text-[14px] leading-relaxed font-normal whitespace-pre-wrap">
                Based on the project requirements and current timeline, I've
                outlined the critical path for the next sprint.
              </p>
            </div>
          )}
          ...
          {/* Hotkeys */}
          <div
            className={`flex items-center px-[18px] pb-0 ${hideMessages ? "pt-5" : "pt-[6px]"} w-full ${spreadHotkeys ? "justify-between gap-1" : "gap-2 overflow-x-auto hide-scrollbar scroll-smooth flex-nowrap"}`}
          >
            {hotkeys.map((a) => (
              <button
                key={a.label}
              ...
              >
                {!dreamyVariant && (
                  <div className="absolute top-0.5 left-2 right-2 h-[45%] rounded-full bg-gradient-to-b from-white/20 to-white/0 blur-[0.5px] pointer-events-none" />
                )}
                <span className="relative flex items-center gap-[5px] whitespace-pre">
                  {a.icon} {a.label}
                </span>
              </button>
            ))}
          ...
          <div className="px-3 pb-[11px] pt-[7px]">
              ...
              >
                {dreamyVariant ? (
                  <span className="flex items-center gap-1.5">
                    ...
                    <kbd className="bg-white/10 px-1.5 py-0.5 rounded text-[10px] border border-white/10 font-sans">
                      ⌘
                    </kbd>
                    <kbd className="bg-white/10 px-1.5 py-0.5 rounded text-[10px] border border-white/10 font-sans">
                      ↵
                  ...
                  "Ask anything — Momor knows your resume and this company..."
                )}
              </div>
            </div>
            <div className="flex items-center justify-between mt-[7px] px-[1px]">
              ...
              <button
                className="w-[26px] h-[26px] rounded-full flex items-center justify-center relative overflow-hidden border border-white/20"
                style={{
                  background:
                    "linear-gradient(160deg, #5B8EF0 0%, #3B6FE8 50%, #2D5FD4 100%)",
              ...
              >
                ...
                <svg width="10" height="10" viewBox="0 0 11 11" fill="none">
                  <path
                    d="M2.5 5.5H8.5M6 3l2.5 2.5L6 8"
                    stroke="white"
                    strokeWidth="1.3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
...
export default MomorInterfaceCard;
