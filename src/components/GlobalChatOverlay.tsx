  ...
  const submitQuestion = useCallback(
    async (question: string) => {
      ...
      try {
        ...
        if (result?.fallback) {
          console.log(
            "[GlobalChat] RAG unavailable, falling back to standard chat",
          );
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative mx-auto w-full max-w-[680px] mb-0 bg-card text-card-foreground rounded-t-[24px] border-t border-x border-border shadow-2xl overflow-hidden flex flex-col"
