...
const STORAGE_KEY = "momor_perms_shown_v1";
...
const GT: React.CSSProperties = {
  background:
    "linear-gradient(140deg, #FFFFFF 25%, rgba(196,181,253,0.9) 100%)",
...
const ITEM = {
  ...
  show: {
    ...
    y: 0,
    filter: "blur(0px)",
    transition: { duration: 0.46, ease: [0.22, 1, 0.36, 1] as any },
  },
};
        ...
        style={
          {
            ...
            background:
              "radial-gradient(ellipse 80% 70% at 50% 50%, rgba(139,92,246,0.06) 0%, rgba(0,0,0,0.84) 100%)",
      ...
      >
        ...
        <motion.div
          ...
          initial={
            reduced
              ? { opacity: 0 }
              : { opacity: 0, scale: 0.93, y: 20, filter: "blur(10px)" }
          }
          animate={
            reduced
              ? { opacity: 1 }
          ...
          exit={
            reduced
              ? { opacity: 0 }
              : { opacity: 0, scale: 0.95, y: 14, filter: "blur(4px)" }
          }
          transition={{
            type: "spring",
            stiffness: 290,
          ...
          style={{
            ...
            borderRadius: "23px",
            boxShadow:
              "0 48px 120px -20px rgba(0,0,0,0.95), 0 0 80px rgba(139,92,246,0.06)",
          }}
        >
          <div
            style={{
              ...
              overflow: "hidden",
              background:
                "linear-gradient(150deg, rgba(10,10,18,0.99) 0%, rgba(6,6,11,1) 100%)",
              fontFamily: T.font,
            }}
          >
            {/* Catch-light */}
            ...
            {!reduced && (
              <motion.div
                ...
                style={{
                  ...
                  height: "280px",
                  background:
                    "radial-gradient(ellipse, rgba(139,92,246,0.28) 0%, transparent 65%)",
                  pointerEvents: "none",
                  zIndex: 1,
                }}
              />
            ...
            >
              ...
              >
                ...
                <motion.div variants={ITEM}>
                  ...
                  >
                    {platform === "darwin"
                      ? "Momor needs access to your screen and microphone to capture meetings and transcribe speech."
                ...
                >
                  <PermRow
                    ...
                    onAction={
                      platform === "darwin" ? openScreenSettings : undefined
                    }
                    reduced={reduced}
                  />
                  <PermRow
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: allGranted
                        ? `0 0 0 1px rgba(109,40,217,0.5), 0 8px 28px rgba(139,92,246,0.35), inset 0 1px 0 rgba(255,255,255,0.18)`
                        : `0 0 0 1px ${T.rule}`,
    ...
    >
      ...
      >
        <Icon
          size={16}
          strokeWidth={1.75}
          color={isGranted ? T.green : isDenied ? T.red : T.violet}
        />
      </div>
        ...
        {platform === "darwin" && !isPending && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 0 8px ${isGranted ? T.greenG : "rgba(248,113,113,0.5)"}`,
            }}
          />
        )}
