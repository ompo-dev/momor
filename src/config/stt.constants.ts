...
export const STT_PROVIDERS: Record<SttProviderId, SttProviderConfig> = {
  ...
  deepgram: {
    id: "deepgram",
    name: "Deepgram Flux (Multilingual STT)",
    description:
      "Real-time flux-general-multi streaming with native code-switching",
  ...
  momor: {
    id: "momor",
    name: "Momor Pro (Managed)",
    description: "All-in-one managed STT via Momor API",
    endpoint: "",
    model: "",
    uploadType: "websocket",
    authHeader: () => ({}),
  ...
  "whisperx-local": {
    id: "whisperx-local",
    name: "WhisperX Local",
    description: "Self-hosted WhisperX OpenAI-compatible server",
