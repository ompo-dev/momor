# momor answer-path architecture notes
...
5. `LLMHelper.streamChat` routes to the active provider (Claude / Gemini / OpenAI / momor / Ollama).
...
- electron/services/**tests**/ModesManager.test.mjs covers the prompt-suffix invariant.
- electron/services/**tests**/PromptAssembler.test.mjs covers the assembly contract.
